...
def test_1step_totVACF(expected_singlestep, singlestep):
    assert np.array_equal(
        expected_singlestep.get("totVACF"), singlestep.totVACF
    )


def test_1step_totVDoS(expected_singlestep, singlestep):
    assert np.array_equal(
        expected_singlestep.get("totVDOS"), singlestep.totVDoS
    )
...
def test_1step_rotVACF(expected_singlestep, singlestep):
    assert np.array_equal(
        expected_singlestep.get("rotVACF"), singlestep.rotVACF
    )


def test_1step_rotVDoS(expected_singlestep, singlestep):
    assert np.array_equal(
        expected_singlestep.get("rotVDOS"), singlestep.rotVDoS
    )
...
def test_1step_rotBondVDoS(expected_singlestep, singlestep):
    assert np.array_equal(
        expected_singlestep.get("rotBondVDOS"), singlestep.rotBondVDoS
    )
...
def test_fulltraj_rotBondVDoS(expected_fulltraj, fulltraj):
    assert np.array_equal(
        expected_fulltraj.get("rotBondVDOS"), fulltraj.rotBondVDoS
    )


def test_residue_properties_output(
    expected_resprops_path, resprops_path, fulltraj_fileoutput
):
    import re
