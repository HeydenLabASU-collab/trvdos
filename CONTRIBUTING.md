...
We welcome all contributions to trvdos!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/HeydenLabASU-collab/trvdos/issues)
...
The second two options both involve making a [pull request](https://github.com/HeydenLabASU-collab/trvdos/pulls) .
